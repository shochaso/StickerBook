...
import { GallerySelectionPage } from './components/gallery-selection-page'
import { MyStickerAlbumPage } from './components/my-sticker-album-page'
      ...
      case 'image-edit':
        return <ImageEditPage 
          ...
          onSave={(data) => {
            ...
            setCurrentScreen('my-sticker-album')
          }}
          capturedImage={capturedImage}
        />
      case 'gallery-selection':
        return <GallerySelectionPage appContext={appContext} />
      case 'my-sticker-album':
        return <MyStickerAlbumPage appContext={appContext} />
      default:
        return <StickerLandingPage appContext={appContext} />
    }
  }
